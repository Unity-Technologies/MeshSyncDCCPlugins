...
SET CMAKE_BUILD_ARGS=-DBUILD_MAYA_ALL=ON -DBUILD_3DSMAX_ALL=ON -DBUILD_BLENDER_ALL=ON -DBUILD_MOTIONBUILDER_ALL=ON -DBUILD_METASEQUOIA_ALL=ON -DBUILD_MODO_ALL=OFF
