...
| Generate UVs | *Off*: Uses UVs on the object, If needed: Generates UVs if there are no usable UVs on the object. <br /> *Always*: Always generates UVs for baking, even if there are existing UVs. <br /> <br /> **NOTE**: These settings can be destructive to existing UVs. |
